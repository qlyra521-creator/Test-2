    ...
    <div className="pt-16 pb-4 px-4 flex flex-col h-screen">
      ...
      {currentUser && (
        <button
          ...
          className="fixed bottom-32 right-4 sm:bottom-8 sm:right-8 w-12 h-12 rounded-full flex items-center justify-center text-white shadow-lg hover:scale-110 transition-transform"
